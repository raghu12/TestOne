...
@synthesize trackerStatusDetailsArr,trackerStatusDetailsTableView;
...
//
  ...
  //  START_MAIN_THREAD
    ...
    if(indexPath.row==0){
           cell.detailLabel.attributedText = [Utils withPlainString:hintText plainColor:((indexPath.row == 0) ? DARK_GRAY_COLOR : DARK_GRAY_COLOR) withColon:@"" withAtrributedString:@"" attributedColor:attrTextColor];
    }
    else{
    cell.detailLabel.attributedText = [Utils withPlainString:hintText plainColor:((indexPath.row == 0) ? DARK_GRAY_COLOR : DARK_GRAY_COLOR) withColon:@":" withAtrributedString:hintText attributedColor:attrTextColor];
    }
  //  END_THREAD
