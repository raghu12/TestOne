...
- (IBAction)submitButton:(id)sender {
    ...
    if(selectTF1.hidden == NO && [selectTF1.text isEqualToString:@"Less Than 15 Years"]){
    ...
    if(selectTF1.hidden == NO && [selectTF1.text isEqualToString:@"Between 15-18 Years"]){
    ...
    if(selectTF1.hidden == NO && [selectTF1.text isEqualToString:@"18 Years And Above"]){
    ...
    if([selectServiceTypeTF.text isEqualToString:@"PCC"]){
        
        feeAmountTitleLabel.hidden=NO;
        feeAmountLine.hidden=NO;
        feeAmountLabel.hidden=NO;
        
        feeAmountLabel.text = @"500";
    }
...
-(void) getSourceDestinationArrayFromAPI {
    ...
    if (![Utils isEmptyValue:selectServiceTypeTF.text] && ![Utils isEmptyValue:selectTF1.text] && ![Utils isEmptyValue:selectTF2.text]) {
    ...
    NSDictionary *params = @{@"deptname":@"passport", @"channel": @"IOS",@"servicecode": @"2", @"mobileno":@"9480497796", @"service": @"6",@"age":@"886",@"scheme":@"342",@"validity":@"",@"pages":@"",@"reason":@""};
        
        [self commonServiceCall:params completionBlock:^(id response, int code) {
            if (code == 0) {
                if (![Utils isEmptyValue:response]) {
                    feeResponseArray =[response valueForKey:@"item"];
                    if (feeResponseArray.count > 0) {
...
-(void) textFieldDidEndEditing:(UITextField *)textField {
    ...
    if (textField == selectServiceTypeTF) {
        ...
        if ([selectServiceTypeTF.text isEqualToString:@"Fresh"]) {
            ...
            selectTF2.isOptionalDropDown = NO;
            [selectTF2 setItemList:[NSArray arrayWithObjects:@"Validity Expired/Due to Expire",@"Delete Ecr / Change in Personal Particular",@"Exhaustion of Pages",@"Lost / Damaged Passport", nil]];
            
            selectTF2.placeholder = @"Select Reason";
            selectTF2.text = @"";
        ...
        } else if ([selectServiceTypeTF.text isEqualToString:@"PCC"]) {
        ...
        if([selectServiceTypeTF.text isEqualToString:@"Fresh"] && [selectTF1.text isEqualToString:@"Less Than 15 Years"]){
        ...
        if([selectServiceTypeTF.text isEqualToString:@"Fresh"] &&  [selectTF1.text isEqualToString:@"Between 15-18 Years"]){
        ...
        if([selectServiceTypeTF.text isEqualToString:@"Fresh"] && [selectTF1.text isEqualToString:@"18 Years And Above"]){
        ...
        ////-----------------
        if([selectServiceTypeTF.text isEqualToString:@"Reissue"] && [selectTF1.text isEqualToString:@"Less Than 15 Years"]){
        ...
        if([selectServiceTypeTF.text isEqualToString:@"Reissue"] &&  [selectTF1.text isEqualToString:@"Between 15-18 Years"]){
        ...
        if([selectServiceTypeTF.text isEqualToString:@"Reissue"] && [selectTF1.text isEqualToString:@"18 Years And Above"]){
        ...
        if([selectServiceTypeTF.text isEqualToString:@"Fresh"] && [selectTF2.text isEqualToString:@"Normal"]){
        ...
        else  if([selectServiceTypeTF.text isEqualToString:@"Fresh"] && [selectTF2.text isEqualToString:@"5 Years/Till the age of 18 years"]){
        ...
        else  if([selectServiceTypeTF.text isEqualToString:@"Fresh"] && [selectTF2.text isEqualToString:@"10 Years"]){
        ...
        else  if([selectServiceTypeTF.text isEqualToString:@"Reissue"] && [selectTF2.text isEqualToString:@"Lost / Damaged Passport"]){
            
            //  selectTF3.showDismissToolbar = YES;
            selectTF3.isOptionalDropDown = NO;
            [selectTF3 setItemList:[NSArray arrayWithObjects:@"Yes",@"No", nil]];
            selectTF3.placeholder = @"Select Expiry";
            selectTF3.text = @"";
    ...
    }else if (textField == selectTF3){
        if([selectServiceTypeTF.text isEqualToString:@"Reissue"] && [selectTF2.text isEqualToString:@"Lost / Damaged Passport"] && [selectTF3.text isEqualToString:@"Yes"]){
            
            //  selectTF3.showDismissToolbar = YES;
            selectTF4.isOptionalDropDown = NO;
            [selectTF4 setItemList:[NSArray arrayWithObjects:@"5 Years/Till the age of 18 years",@"10 Years", nil]];
            selectTF4.placeholder = @"Select required validity";
            selectTF4.text = @"";
            ...
            // selectTF4.showDismissToolbar = YES;
            selectTF5.isOptionalDropDown = NO;
            [selectTF5 setItemList:[NSArray arrayWithObjects:@"Normal",@"Tatkaal", nil]];
            selectTF5.placeholder = @"Select scheme type";
            selectTF5.text = @"";
